...
public class BiodataFrame extends JFrame{
    ...
    private final ModelTabel tableModel; // Variable tableModel untuk menyimpan tableModel
    ...
    public BiodataFrame(BiodataDao biodataDao) {
        ...
        tableModel = new ModelTabel(biodataList);
    ...
    public ModelTabel getTableModel() {
    ...
    public void showAlertAllEmpty() {
        ...
        //dengan title pada parameter 3 dan jenis pesan pada parameter 4
        JOptionPane.showMessageDialog(BiodataFrame.this, "Nama, telepon dan alamat belum terisi", 
                "Perhatian",
    ...
    public void showAlertNameEmpty() {
        // Tampilkan message dialog pada komponen dari parameter 1 dan pesan pada parameter 2 dengan title pada parameter 3 
        //dan jenis pesan pada parameter 4
